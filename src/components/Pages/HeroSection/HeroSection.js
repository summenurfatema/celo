    ...
    return (
      ...
      <p className='pr-24 py-6 text-2xl font-thin hidden md:block'>Celo is the carbon-negative, mobile-first, EVM-compatible blockchain ecosystem 
        ...
        <div className='md:flex space-x-7 hidden'>
            ...
            <div className='space-x-7 space-y-3 md:hidden'>
            <p className='px-3 py-6 text-xl font-thin'>Celo is the carbon-negative, mobile-first, EVM-compatible blockchain ecosystem 
        leading a thriving new digital economy for all.</p>
                <button className='bg-yellow-300 font-semibold px-8 rounded-full py-3 text-xl'>Build with celo</button>
                <button className='font-semibold text-xl pl-3'>Join the community <span><IoMdArrowDropright className='inline text-xl md:text-2xl rounded-full text-white bg-gray-900 hover:bg-yellow-300 hover:text-black'/></span> <span className='h-7 w-7 bg-black rounded-full hover:bg-yellow-300'></span> </button>
            </div>
        </div>
    );
};
